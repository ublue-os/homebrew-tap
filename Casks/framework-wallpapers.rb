cask "framework-wallpapers" do
  ...
  on_macos do
    url "https://github.com/hanthor/artwork/releases/latest/download/framework-wallpapers-macos.tar.zstd"
  end
  ...
  on_linux do
    ...
    if is_gnome
      url "https://github.com/hanthor/artwork/releases/latest/download/framework-wallpapers-gnome.tar.zstd"
    elsif is_kde
      url "https://github.com/hanthor/artwork/releases/latest/download/framework-wallpapers-kde.tar.zstd"
    else
      url "https://github.com/hanthor/artwork/releases/latest/download/framework-wallpapers-png.tar.zstd"
    end
  end
