    ...
    run "ruby", args: [
      ...
      <<~RUBY,
        ...
        if vscode_dir
          ...
          File.write("\#{vscode_dir}/code-insiders.desktop", <<~EOS)
            [Desktop Entry]
            Name=Visual Studio Code - Insiders
            Comment=Code Editing. Redefined.
            GenericName=Text Editor
            Exec=\#{prefix}/bin/code-insiders %F
            ...
            Exec=\#{prefix}/bin/code-insiders --new-window %F
            Icon=\#{vscode_dir}/resources/app/resources/linux/code.png
          EOS

          File.write("\#{vscode_dir}/code-insiders-url-handler.desktop", <<~EOS)
            [Desktop Entry]
            Name=Visual Studio Code Insiders - URL Handler
            Comment=Code Editing. Redefined.
            GenericName=Text Editor
            Exec=\#{prefix}/bin/code-insiders --open-url %U
            Icon=\#{vscode_dir}/resources/app/resources/linux/code.png
            Type=Application
            NoDisplay=true
            StartupNotify=true
